...
--working with decimal data and need calculations to be exact
-- (dealing with money, for example), choose numeric or its equivalent,
-- decimal. Float types will save space, but the inexactness of floatingpoint
-- math won’t pass muster in many applications. Use them only
-- when exactness is not as important.

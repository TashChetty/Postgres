...
--FROM 'C:\SQL\Chapter_04\your_file.csv'
...
COPY us_counties_2010
FROM 'C:\SQL\Chapter_04\us_counties_2010.csv'
WITH (FORMAT CSV, HEADER);
...
FROM 'C:\SQL\Chapter_04\supervisor_salaries.csv'
WITH (FORMAT CSV, HEADER);
...
COPY us_counties_2010
TO 'C:\SQL\Chapter_04\us_counties-export.txt'
...
TO 'C:\SQL\Chapter_04\us_counties-latlon_export.txt'
WITH (FORMAT CSV, HEADER, DELIMITER '|');
